...
describe("logic", () => {
  ...
  describe("validation functions", () => {
    ...
    it("validates duplicate tile positions", () => {
      const board = createEmptyBoard();
      const tiles = [
        { letter: "A" as Letter, coord: { row: 7, col: 7 } },
        { letter: "B" as Letter, coord: { row: 7, col: 7 } }, // Duplicate position
      ];
    ...
    it("validates out-of-bounds coordinates", () => {
      const board = createEmptyBoard();
      const tiles = [
        { letter: "A" as Letter, coord: { row: 15, col: 7 } }, // Out of bounds
      ];
    ...
    it("validates occupied cells", () => {
      ...
      const tiles = [
        { letter: "A" as Letter, coord: { row: 7, col: 7 } }, // Try to place on occupied cell
      ];
    ...
    it("validates straight line placement", () => {
      ...
      const tiles = [
        { letter: "A" as Letter, coord: { row: 7, col: 7 } },
        { letter: "B" as Letter, coord: { row: 8, col: 8 } }, // Not in straight line
      ];
    ...
    it("validates adjacent tiles in horizontal line", () => {
      ...
      const tiles = [
        { letter: "A" as Letter, coord: { row: 7, col: 7 } },
        { letter: "B" as Letter, coord: { row: 7, col: 9 } }, // Gap in line
      ];
    ...
    it("validates adjacent tiles in vertical line", () => {
      ...
      const tiles = [
        { letter: "A" as Letter, coord: { row: 7, col: 7 } },
        { letter: "B" as Letter, coord: { row: 9, col: 7 } }, // Gap in line
      ];
    ...
    it("validates first move touches center star", () => {
      const board = createEmptyBoard();
      const tiles = [
        { letter: "A" as Letter, coord: { row: 6, col: 6 } }, // Not touching center
      ];
    ...
    it("validates subsequent moves connect to existing tiles", () => {
      ...
      const tiles = [
        { letter: "A" as Letter, coord: { row: 5, col: 5 } }, // Not connected to existing
      ];
    ...
    it("validates word formation", () => {
      ...
      const tiles = [
        { letter: "A" as Letter, coord: { row: 7, col: 7 } },
        { letter: "B" as Letter, coord: { row: 7, col: 8 } },
      ];
    ...
    it("validates connected tiles", () => {
      ...
      const tiles = [
        { letter: "A" as Letter, coord: { row: 5, col: 5 } }, // Disconnected from existing tiles
        { letter: "B" as Letter, coord: { row: 5, col: 6 } },
      ];

      expect(() => extractAllWords(tiles, board, false)).toThrow(
        "tiles_must_be_connected"
      );
    });
    ...
    it("validates valid connected tiles", () => {
      ...
      const tiles = [
        { letter: "A" as Letter, coord: { row: 6, col: 7 } }, // Connected to existing
        { letter: "B" as Letter, coord: { row: 6, col: 8 } },
      ];
